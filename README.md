...
| unstable-20-net7 | Identical to `unstable` tag                                                                       |                                           |         | 1.22.20 | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-node/unstable-20-net7?style=flat-square) |
